...
const Projects = (props) => {
    return (
        <div className=' container my-4 mx-auto'>
            <h3 className="display-5 mx-15" style={{color:props.mode === 'light' ? '#17202A':'#fff', textAlign:'center'}}>Projects</h3>
            <div className='row table-row' style={{justifyContent:'center'}}>
                ...
                <div className="card mx-3 shadow-sm p-3 mb-5 bg-body rounded" style={{width: 300,}}>
                    ...
                    <div className="card-body">
                        ...
                        <a href="/" className={`btn btn-outline-${props.mode === 'light' ? 'dark':'light'} mx-auto`}
                            style={{color:props.mode === 'light' ? '#17202A':'#fff', 
                            backgroundColor:props.mode === 'light' ? '#fff':'#17202A', alignContent:'center'}}>Code</a>
                    </div>
                </div>
            <div className="col-3 my-3 mx-auto" style={{justifyContent:'center'}}>
